...
export const mockNewsData: NewsArticle[] = [
    ...
    history: [
      {
        ...
        title: '대한교조, 리박스쿨, 뉴라이트의 극우 역사 세미나',
        body: '대한교조가 주최한 역사 세미나에서 논란이 되고 있는 내용들이 다뤄졌습니다. 이번 세미나는 역사 교육의 방향성에 대한 중요한 논의의 장이 되었습니다.',
        changeType: 'both'
      },
      {
        timestamp: '2025-06-27 12:15',
        title: '대한교조, 리박스쿨과 함께하는 역사 세미나 개최',
        body: '대한교조가 주최한 역사 세미나가 개최되었습니다. 이번 세미나에서는 다양한 역사적 관점이 논의되었습니다.',
        changeType: 'title'
      },
      {
    ...
    history: [
      {
        ...
        title: '정부, 탄소중립 정책 전면 재검토 발표',
        body: '정부가 기존 탄소중립 정책을 전면 재검토하겠다고 발표했습니다. 이는 경제적 부담과 실현 가능성을 고려한 결정으로 보입니다. 환경단체들은 강력히 반발하고 있습니다.',
        changeType: 'both'
      },
      {
      ...
      },
      {
        ...
        title: '정부, 탄소중립 정책 관련 발표 예정',
        body: '정부가 탄소중립 정책과 관련된 중요한 발표를 할 예정입니다.',
        changeType: 'content'
      }
    ]
  },
  ...
  },
  {
    ...
    history: [
      ...
      {
        timestamp: '2025-06-24 14:20',
        title: '삼성전자, AI 칩셋 개발 발표',
        body: '삼성전자가 AI 칩셋 개발과 관련된 발표를 했습니다.',
        changeType: 'both'
      }
    ]
  },
  ...
  },
  {
    ...
    history: [
      ...
      },
      {
        timestamp: '2025-06-26 16:20',
        title: '정부, 탄소중립 정책 일부 수정 검토',
        body: '정부가 기존 탄소중립 정책의 일부 수정을 검토하고 있다고 발표했습니다.',
        changeType: 'title'
      }
    ]
  },
